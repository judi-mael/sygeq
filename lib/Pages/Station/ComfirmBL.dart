...
class ConfirmBL extends StatefulWidget {
  final data;
  int bl;
  ConfirmBL({Key? key, required this.bl, required this.data}) : super(key: key);

  @override
  State<ConfirmBL> createState() => _ConfirmBLState();
}

class _ConfirmBLState extends State<ConfirmBL> {
  // List blList = [];
  ...
  getInforBl() async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => HomeStation(refreshData: true)),
      );
    }
  }
                      ...
                      updateBL().then((value) {
                        if (value['statut'] == true) {
                          ...
                          Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (context) => HomeStation(refreshData: true),
                            ),
                          );
                        } else {
                          setState(() {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => HomeStation(refreshData: true),
                  ),
                );
              },
          ...
          child:
              _animate == true
                  ...
                  ? blList['statut'] != "Chargé"
                      ...
                      ? actionQtteApres()
                      : loader == true
                      ? veuillezPatienter("Déchargement encours")
                      : SingleChildScrollView(
                        physics: const AlwaysScrollableScrollPhysics(),
                        child: Padding(
