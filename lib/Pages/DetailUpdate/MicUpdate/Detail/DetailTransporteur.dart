...
import 'package:sygeq/Pages/DetailUpdate/MicUpdate/UpdateTransporteur.dart';
import 'package:sygeq/Services/RemoteServiceDisable.dart';
import 'package:sygeq/main.dart';

class DetailTransporteur extends StatefulWidget {
  var data;
  DetailTransporteur({Key? key, required this.data}) : super(key: key);

  @override
  State<DetailTransporteur> createState() => _DetailTransporteurState();
}
...
class _DetailTransporteurState extends State<DetailTransporteur> {
  ...
  actionOnTheEditTransporteur(var data) {
    showDialog(
      context: context,
        ...
        return Padding(
          ...
          child: Dialog(
            ...
            child: Container(
              ...
              child: UpdateTransporteur(data: data),
            ),
          ),
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    //                         MaterialPageRoute(
    //                             builder: (context) =>
    //                                 UpdateTransporteur(data: widget.data)));
    //                   },
    //                 ),
    //               ),
    //             ],
                    ...
                    if (prefUserInfo['type'] == 'Marketer')
                      Flexible(
                        child: IconButton(
                          ...
                          onPressed: () {
                            actionOnTheEditTransporteur(widget.data);
                            // Navigator.pushReplacement(
                            //     context,
                            //     MaterialPageRoute(
                            //         builder: (context) =>
                            //             UpdateMarketer(data: widget.data)));
                          },
                        ),
                      ),
                  ],
                  ...
                  Flexible(
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible(flex: 4, child: Text('IFU : ', style: styleG)),
                      ],
                    ),
                  ),
                  Flexible(
                  ...
                  Flexible(
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible(
                          flex: 4,
                          child: Text('Agrement:', style: styleG),
                        ),
                      ],
                    ),
                  ),
              ...
              child: Row(
                ...
                children: [
                  Flexible(
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible(
                          flex: 4,
                          child: Text('Autorisation', style: styleG),
                        ),
                      ],
                    ),
                  ),
                  Flexible(
                    flex: 4,
                    child: Text(
                      "${DateFormat('dd MMM yyyy ').format(DateTime.parse(widget.data['DateStart']))} ${DateFormat('dd MMM yyyy ').format(DateTime.parse(widget.data['DateEnd']))}",
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
