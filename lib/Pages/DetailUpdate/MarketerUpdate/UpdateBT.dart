...
class UpdateBT extends StatefulWidget {
  var data;
  Depot depot;
  Marketer marketer;
  Camion camion;
  ...
  @override
  State<UpdateBT> createState() => _UpdateBTState();
}

class _UpdateBTState extends State<UpdateBT> {
  ...
  void initState() {
    depotInterieur();
    listDepotInterieur.removeWhere((element) => element.id == 0);
    // listDepotInterieur.add(Station(
    //     id: 0,
