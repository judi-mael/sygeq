...
class UpdateBLCharger extends StatefulWidget {
  var data;
  StationBl station;

  UpdateBLCharger({Key? key, required this.data, required this.station})
    : super(key: key);

  @override
  State<UpdateBLCharger> createState() => _UpdateBLChargerState();
}

class _UpdateBLChargerState extends State<UpdateBLCharger> {
