...
class UpdateBTCharger extends StatefulWidget {
  var data;
  Depot station;

  UpdateBTCharger({Key? key, required this.data, required this.station})
    : super(key: key);

  @override
  State<UpdateBTCharger> createState() => _UpdateBTChargerState();
}

class _UpdateBTChargerState extends State<UpdateBTCharger> {
                      ...
                      children: [
                        Padding(
                          ...
                          child: DropdownSearch<String>(
                            ...
                            items:
                                listDepotInterieur.map((e) => e.nom).toList(),
                            validator:
                                (value) =>
                                    value == null
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                int index = listDepotInterieur.indexWhere(
                                  (element) =>
                                      element.nom == newValue.toString(),
                                );
                                // dropdownValue = newValue!;
                                idStation =
                                    listDepotInterieur[index].id.toString();
                              });
                            },
