...
class DetailBLDispatcheur extends StatefulWidget {
  ...
  @override
  State<DetailBLDispatcheur> createState() => _DetailBLDispatcheurState();
}

class _DetailBLDispatcheurState extends State<DetailBLDispatcheur> {
  int id = 0;
            ...
            widget.data["statut"] == "Ouvert"
                ? Row(
                  ...
                  children: [
                    ...
                    // Visibility(
                    //   visible: widget.data["statut"] == "Ouvert" ||
                    //           widget.data["statut"] == "Approuvé"
                    //       ? true
                    //       : false,
                    //   child:
