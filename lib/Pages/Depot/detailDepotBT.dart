...
class DetailDestinationBT extends StatefulWidget {
  var data;
  Depot depot;
  Marketer marketer;
  Camion camion;
  ...
  @override
  State<DetailDestinationBT> createState() => _DetailDestinationBTState();
}

class _DetailDestinationBTState extends State<DetailDestinationBT> {
  @override
  ...
  void _getCurrentPosition() async {
    ...
    if (permission == LocationPermission.denied ||
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder:
              (context) => DepotScannerQR(
                id: widget.camion.id,
                id_bl: widget.data['id'],
