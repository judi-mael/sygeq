...
import 'package:sygeq/Pages/Depot/ValidateBL.dart';
...
class NewBC extends StatefulWidget {
  bool depotAppBar;
  NewBC({Key? key, required this.depotAppBar}) : super(key: key);

  @override
  State<NewBC> createState() => _NewBCState();
}

class _NewBCState extends State<NewBC> {
  ...
  bool _animate = true;
  // List<String> text = ["BL-280255A", "BL-JNP28255", "BL 25801"];
  // final noti = [
  //   CheckboxState(title: "BL-280255A"),
  //   CheckboxState(title: "BL-JNP28255"),
  //   CheckboxState(title: "BL 25801"),
  // ];
