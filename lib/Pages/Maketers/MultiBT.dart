...
class MultiBT extends StatefulWidget {
  bool? gazoil;
  MultiBT({Key? key, this.gazoil}) : super(key: key);

  @override
  State<MultiBT> createState() => _MultiBTState();
}

class _MultiBTState extends State<MultiBT> {
  List? mesProduit = [];
  bool _addBl = true;
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 5,
                              child: Text(
                                listDepotInterieur[listDepotInterieur
                                        .indexWhere(
                                          (element) =>
                                              element.id ==
                                              detailDuBl.stationId,
                                        )]
                                    .nom,
                                overflow: TextOverflow.ellipsis,
                                softWrap: true,
  ...
  getProduct() async {
    ...
    if (widget.gazoil == true) {
      productList = [
        Produit(
          unite:
              productList[productList.indexWhere(
                    (elts) => elts.nom == 'GASOIL',
                  )]
                  .unite,
          id:
              productList[productList.indexWhere(
      ...
      productList.removeWhere((elts) => elts.nom == 'GASOIL');
    }
    return productList;
  }
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Voulez-vous annuler le processus de création de BT en cours?",
                    softWrap: true,
                    maxLines: 5,
                    overflow: TextOverflow.ellipsis,
                    style: styleG,
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "Destination : ${listDepotInterieur[listDepotInterieur.indexWhere((element) => element.id == _listMultiBl[i].stationId)].nom}",
                                            style: GoogleFonts.montserrat(
                                              color: Colors.blue,
