...
class CreateBT extends StatefulWidget {
  const CreateBT({Key? key}) : super(key: key);

  @override
  State<CreateBT> createState() => _CreateBTState();
}

class _CreateBTState extends State<CreateBT> {
  List? mesProduit = [];
  String prod = "";
  String qt = "";
  int capacity = 0;
                  ...
                  child: DropdownSearch<String>(
                    ...
                    onChanged: (String? newValue) {
                      setState(() {
                        ...
                        txtStation.text = depList[index].id.toString();
                      });
                    },
                    dropdownDecoratorProps: DropDownDecoratorProps(
                      dropdownSearchDecoration: InputDecoration(
