...
class AddNewAllUsers extends StatefulWidget {
  const AddNewAllUsers({super.key});

  @override
  State<AddNewAllUsers> createState() => _AddNewAllUsersState();
}

class _AddNewAllUsersState extends State<AddNewAllUsers> {
  final formKey = GlobalKey<FormState>();
  late TextEditingController txtEmail, txtName, txtUserName;
  String userRole = "";
  String typeUser = "";
  String station = "";
  bool _visible = false;
  ...
  depotAddUer() async {
    var data = await RemoteServices.allAddUser(
